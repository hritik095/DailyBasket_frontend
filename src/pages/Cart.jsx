...
const Cart = () => {
  ...
  if (cartArray.length === 0) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center text-gray-600 py-10 px-4">
        <svg
        ...
        >
          <path
            ...
            strokeWidth="1.5"
            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.5 7H19m-12 0a1 1 0 1 0 2 0m8 0a1 1 0 1 0 2 0"
          ></path>
        </svg>
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                ...
                <p
                  ...
                  className="text-indigo-500 text-center cursor-pointer p-2 hover:bg-indigo-100"
                >
                  Add address
                </p>
              </div>
